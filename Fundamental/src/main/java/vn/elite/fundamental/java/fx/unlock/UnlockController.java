...
/**
 * The controller for our 'Unlock' application, see 'Unlock.fxml'. This class has all the logic to open the theater's
 * doors using JavaFX transitions.
 */
public final class UnlockController {
    ...
    void unlockPressed(ActionEvent event) {
        ...
        openLockBottom.setOnFinished(e -> {
    ...
    void initialize() {
        ...
        root.addEventHandler(KeyEvent.KEY_TYPED, (EventHandler<Event>) event -> {
