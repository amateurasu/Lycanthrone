...
public class JavaFinder {
    ...
    /**
     * @param wow64     0 for standard registry access (32-bits for 32-bit app, 64-bits for 64-bits app) or
     *                  WinRegistry.KEY_WOW64_32KEY to force access to 32-bit registry view, or
    ...
    /**
     * @return A list of JavaInfo with informations about all javas installed on this machine Searches and returns
     * results in this order: HKEY_LOCAL_MACHINE\SOFTWARE\JavaSoft\Java Runtime Environment (32-bits view)
     ...
     * HKEY_LOCAL_MACHINE\SOFTWARE\JavaSoft\Java Development Kit     (64-bits view) WINDIR\system32 WINDIR\SysWOW64
     ****************************************************************************/
    ...
    /**
     * @return The path to a java.exe that has the same bitness as the OS (or null if no matching java is found)
     ****************************************************************************/
