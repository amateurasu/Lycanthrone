...
public class ExampleCompiler/*@bgen(jjtree)*/ implements ExampleCompilerTreeConstants, ExampleCompilerConstants {/*@bgen(jjtree)*/
    ...
    public ExampleCompiler(InputStream stream) {
        this(stream, null);
    }

    /** Constructor with InputStream and supplied encoding */
    public ExampleCompiler(InputStream stream, String encoding) {
        try {
    ...
    /** Constructor. */
    public ExampleCompiler(Reader stream) {
    ...
    final protected void varDeclaration() throws ParseException {/*@bgen(jjtree) VarDeclare */
        ASTVarDeclare jjtn000 = new ASTVarDeclare(JJTVARDECLARE);
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);
        Token _token;
        try {
