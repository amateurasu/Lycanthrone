...
public class ExampleCompilerTokenManager implements ExampleCompilerConstants {
    ...
    static final int[] jjnextStates = {4, 5, 7};
                ...
                do {
                    switch (jjstateSet[--i]) {
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            if ((0x14400010000000L & l) != 0L) { jjCheckNAddStates(0, 2); }
                            break;
                        default:
                            break;
                    }
