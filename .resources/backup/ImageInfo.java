 ...
 * ii.determineImageNumber(true); // default is false
 ...
 *   ", " + ii.width() + " x " + ii.height() + " pixels, " +
 *   ii.bitsPerPixel() + " bits per pixel, " + ii.numberOfImages() +
 ...
 * determineImageNumber(true) before calling check().
