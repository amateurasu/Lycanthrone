...
public class PatchExtensionMethodPortal {
    ...
    private static final class Reflection {
        ...
        static {
            ...
            try {
                m = PatchExtensionMethod.class.getMethod(
                    "resolveType", Class.forName(TYPE_BINDING), Class.forName(MESSAGE_SEND),
                    Class.forName(BLOCK_SCOPE));
                ...
                o = PatchExtensionMethod.class.getMethod(
                    "invalidMethod", Class.forName(PROBLEM_REPORTER), Class.forName(MESSAGE_SEND),
                    Class.forName(METHOD_BINDING));
            } catch (Throwable t) {
