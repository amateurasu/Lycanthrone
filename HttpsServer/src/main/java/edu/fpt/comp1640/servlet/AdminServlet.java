...
public class AdminServlet extends HttpServlet {
    ...
    private void getEvent(HttpServletRequest request, HttpServletResponse response) throws IOException {
        //language=SQL
        val sql = "SELECT id, name, year, first_deadline, second_deadline  FROM PublishYears PY LIMIT 10 OFFSET ?";
        val fields = new String[]{"id", "name", "year", "first_deadline", "second_deadline"};
        int offset;
        try {
