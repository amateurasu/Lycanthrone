;(function (root, factory) {
    ...
    var defaults = {
        "autoScrollSize": true,     // automatically calculate scroll size
    ...
    BaseScrollbar.prototype = {
        destroy: function () {
            ...
            this.container.insertBefore(this.wrapper).css({
                ...
                .off(this.namespace).scrollLeft(scrollLeft).scrollTop(scrollTop);
     ...
     *
     * @param {Boolean} actualSize actual size or CSS size, default - CSS size
