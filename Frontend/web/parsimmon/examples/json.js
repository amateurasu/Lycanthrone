...
// JSON is pretty relaxed about whitespace, so let's make it easy to ignore after most text.
...
const JSONParser = P.createLanguage({
    ...
    // `.result` is like `.map` but it takes a value instead of a function, and always returns the same value.
