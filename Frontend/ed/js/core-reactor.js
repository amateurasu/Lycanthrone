            ...
            hex: {
                ...
                de: input => {
                    try {
                        ...
                        const s_cape = escape || encodeURIComponent;
                ...
                en: input => {
                    const uns_cape = unescape || decodeURIComponent;
            ...
            b64: {
                ...
                de: input => {
                    try {
                        return isNode
                            ...
                            : decodeURIComponent(atob(input).split("")
                ...
                en: input => {
                    return isNode
                        ...
                        : btoa(encodeURIComponent(input).replace(/%([0-9A-F]{2})/g,
