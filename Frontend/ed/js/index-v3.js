...
((d, w, core) => {
    //region declare
    const btn = {clear: $("#clear"), go: $("#go"), copy: $("#copy")};
    const nav = {div: $("#side-nav"), open: $(".open-nav"), close: $(".close-nav"), overlay: $(".overlay")};
    ...
    const target = {prefix: "de_", list: standards, div: $("#decrypt"), txt: $('#output'), id: "txt",};
    const drop = {
        div: $("#drop-ctn"), all: $("#all-crypt"), recent: $("#recent-crypt"), close: $("#drop-close"),
        search: $("#search"), ed: "", init: !1, show: !1
    };
    //endregion declare
